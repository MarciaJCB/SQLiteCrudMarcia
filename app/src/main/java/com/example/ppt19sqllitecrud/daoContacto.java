package com.example.ppt19sqllitecrud;
...
public class daoContacto {
    SQLiteDatabase bd; //Instancia e la base de datos
    ArrayList<Contacto>lista = new ArrayList<>(); //Almacena una lista de objetos de tipo contacto
    Contacto c;//Instancia la clase contacto utilizada para operaciones de busqueda
    Context ct; //Contexto de la aplicación
    String nombreDB = "BDContactos"; //Nombre de la Base de datos
    ...
    public boolean editar(Contacto c){
        //metodo para actualizar la información de un contacto en la base de datos
        ContentValues contenedor = new ContentValues();
        contenedor.put("nombre", c.getNombre());
        contenedor.put("apellido", c.getApellido());
        contenedor.put("email", c.getEmail());
